...
"><div class="parallax-container img-loaded" data-velocity="-.140" style="background: url(&quot;https://Instant Loans Deals.com/assets/images/slider/header-bg-105.jpg&quot;) -13.02px;"></div>
	<div class="container">
		<div class="page-title">
			...
			<h1><?php echo !empty($terms_condition['title']) ? $terms_condition['title'] : 'Not yet any policy'; ?></h1>
		</div>
		<div class="breadcrumb">
			<ul itemscope="" itemtype="https://schema.org/BreadcrumbList">
			  ...
			  <li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem">
			    <a itemprop="item" href="<?= base_url('terms-conditions')?>">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="card">
	                <div class="card-body">
	                   <?php echo !empty($terms_condition['description']) ? $terms_condition['description'] : 'Not yet any terms & condition'; ?>
