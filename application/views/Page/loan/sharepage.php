        ...
        <div class="row">
            <div class="col-md-12 px-0 form-main">
                <div class="card  form-card">
                    ...
                    <?php echo form_open_multipart('admin/Home/loan_lead_update');?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="net_salary" id="net_salary" value="<?= $loans['net_salary']?>" class="form-control" >
                        </div> 
                        <div class="col-md-3 mb-3">
                        ...
                        <div class="col-md-12 pb-3 mb-3" style="border-bottom: 1px solid #0000004a;">
                            ...
                            <tbody id="leadBody">
                                ...
                                <tr>						
                                    ...
                                    <a href="<?= base_url()?><?= $doc['image']?>" target ="_blank">View</a></td><?php }?></td>
                                    <!-- <td class=''>
                                        <a href="<?= base_url()?>admin/Dashboard/document_del/<?= $doc['id']?>"  onclick="return confirm('Are you sure ?')"><i class="fa fa-trash text-danger fa-lg" aria-hidden="true"></i></a>
                                    </td> -->
                                </tr> 
                                <?php }} ?>
                            </tbody> 
