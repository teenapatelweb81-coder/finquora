...
<div class="card">
  ...
  <div class="card-header bg-white border-0">
    <div class="row align-items-center">
        <div class="col-8">
            <h3 class="mb-0" style="font-size: 23px;">Add New Loan</h3>
        </div>
          ...
          <div class="col-md-12 px-0">
            <div class="card card-default">
              ...
              <div class="card-body p-0">
                ...
                <form class="form-horizontal" action="<?= base_url('admin/Dashboard/loan_lead_add')?>" method="post" enctype="multipart/form-data">
