...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">Business Loan Update</li> 
            </ol>
         </nav>
</div>
        ...
        <div class="row m-0">
            <div class="col-md-12 px-0 form-main">
                <div class="card  form-card">
                    ...
                    <?php echo form_open_multipart('admin/Dashboard/business_lead_update');?>
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                             ...
                             <input required type="hidden" name="apply_for_loan" class="form-control" value="<?= $loans['apply_for_loan']?>">
                         </div> 
                         <div class="col-md-3 mb-3">
                        ...
                        <div class="col-md-3 mb-3">
                         ...
                         <div class="col-md-3 mb-3">
                             ...
                             <select name="annual_turnover" id="annual_turnover" tabindex="8" class="form-control" required>
                                <option value="">Select</option>
                                ...
                                <option <?php if($loans['annual_turnover'] == 'one_crore_plus'){echo 'selected';}?> value="one_crore_plus">1 Crore +</option>
                            </select>
                         </div> 
                        <div class="col-md-3 mb-3">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select required  name="business_age" id="business_age" tabindex="9" class="form-control">
                                <option value="">Select</option>
                                <option  <?php if($loans['business_age'] == "6_months"){echo 'selected';}?> value="6_months">6 Months</option>
                                ...
                                <option <?php if($loans['business_age'] == "3_year_plus"){echo 'selected';}?> value="3_year_plus">3 Year +</option>
                            </select>
                         </div> 
                         
                         <div class="col-md-3 mb-3">
                             <label for="business_type" class="form-label">Business Type<span class="text-danger">*</span></label>
                             <select required name="business_type" id="business_type" tabindex="6" class="form-control">
                                <option value="">Select</option>
                         ...
                         <div class="col-md-3 mb-3">
                             ...
                             <select required name="nature_of_business" id="nature_of_business" tabindex="7" class="form-control">
                                <option value="">Select</option>
                                <option <?php if($loans['nature_of_business']== 'manufacturing'){echo 'selected';}?>  value="manufacturing">Manufacturing</option>
                                <option <?php if($loans['nature_of_business']== 'trading'){echo 'selected';}?>  value="trading">Trading</option>
                                <option <?php if($loans['nature_of_business']== 'service'){echo 'selected';}?>  value="service">Service</option>
                                <option <?php if($loans['nature_of_business']== 'retailer'){echo 'selected';}?>  value="retailer">Retailer</option>
                        </select>
                         </div> 

                        <div class="col-md-3 mb-3">
                             <label for="business_registration_proof" class="form-label">Business Registration Proof<span class="text-danger">*</span></label>
                            <select required name="business_registration_proof" id="business_registration_proof" tabindex="10" class="form-control">
                                <option value="">Select</option>
                                <option <?php if($loans['business_registration_proof']= "GST"){echo 'selected';}?> value="GST">GST</option>
                                <option <?php if($loans['business_registration_proof']= "VAT"){echo 'selected';}?> value="VAT">VAT</option>
                                <option <?php if($loans['business_registration_proof']= "TAN"){echo 'selected';}?> value="TAN">TAN</option>
                                <option <?php if($loans['business_registration_proof']= "TIN"){echo 'selected';}?> value="TIN">TIN</option>
                                <option <?php if($loans['business_registration_proof']= "MSME"){echo 'selected';}?> value="MSME">MSME</option>
                                <option <?php if($loans['business_registration_proof']= "Shop Establishment Certificate"){echo 'selected';}?> value="Shop Establishment Certificate">Shop Establishment Certificate</option>
                                <option <?php if($loans['business_registration_proof']= "Trade License"){echo 'selected';}?> value="Trade License">Trade License</option>
                                <option <?php if($loans['business_registration_proof']= "Fssai License"){echo 'selected';}?> value="Fssai License">Fssai License</option>
                            </select>
                         </div>
                        <div class="col-md-3 mb-3">
                                    <label for="business_premises" class="form-label">Business Premises<span class="text-danger">*</span></label>
                                      <select required name="business_premises" id="business_premises" tabindex="32" class="form-control">
                                        <option selected="selected" value="Select">Select</option>
                                        <option <?php if( $loans['business_premises'] = "owned"){echo 'selected';}?> value="owned">Owned</option>
                                        <option <?php if($loans['business_premises'] = "rented"){echo 'selected';}?> value="rented">Rented</option>
                                    </select>
                        </div> 

                        <div class="col-md-3 mb-3">
                             <label for="how_many_year_itr_available" class="form-label">How Many Year ITR Available<span class="text-danger">*</span></label>
                            <select required name="how_many_year_itr_available" id="how_many_year_itr_available" tabindex="11" class="form-control">
                                <option value="">Select</option>
                                <option <?php if($loans['how_many_year_itr_available']== "1_year"){echo 'selected';}?> value="1_year">1 Year</option>
                                <option <?php if($loans['how_many_year_itr_available']== "2_year"){echo 'selected';}?> value="2_year">2 Year</option>
                                <option <?php if($loans['how_many_year_itr_available']== "3_year_plus"){echo 'selected';}?> value="3_year_plus">3 Year +</option>
                            </select>
