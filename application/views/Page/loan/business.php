          ...
          <div class="col-md-12">
            <div class="card card-default">
              ...
              <div class="card-body p-0">
                ...
                <form class="form-horizontal" action="<?= base_url('admin/businessloan-insert')?>" method="post" enctype="multipart/form-data">
         ...
         <div id="information-part1" class="content" role="tabpanel" aria-labelledby="information-part1-trigger">
                <div class="row">
                     ...
                     <div id="information-part" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
                      ...
                      <button class="btn btn-primary" onclick="stepper.previous()">Previous</button>
                      <button type="submit" class="btn btn-primary">Send to</button>
