    ...
    font-size: 12px !important;
        ...
        <section>
            ...
            <div class="container agent_container">
                ...
                <?php echo form_open('/brancepayment',array('method'=>'post'));?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="credit-card">
                            ...
                            <span class="plan-details p-3 p-3" aria-hidden="true">
                              ...
                              <span class="plan-cost"><?= (isset($data[0]->amount)) ? $data[0]->amount : 0 ; ?>₹
                              ...
                              <p><?= (isset($silver['branch_card_plan'])) ? $silver['branch_card_plan'] : '' ; ?></p>
                        ...
                        <div class="credit-card">
                            ...
                            <span class="plan-details p-3" aria-hidden="true">
                              ...
                              <span class="plan-cost"><?= (isset($data[0]->amount2)) ? $data[0]->amount2 : 0 ; ?> ₹
                              ...
                              <p><?= (isset($platinum['branch_card_plan'])) ? $platinum['branch_card_plan'] : '' ; ?></p>
                      ...
                      <div class="col-md-6">
                            <label class="card">
                              ...
                              <span class="plan-details p-3 p-3" aria-hidden="true">
                                ...
                                <p><?= (isset($silver['branch_free_card_plan'])) ? $silver['branch_free_card_plan'] : '' ; ?></p>
                              </span>
                          </label> 
                        </div>
                        ...
                        <div class="col-md-6">
                            <label class="card">
                              ...
                              <span class="plan-details p-3 p-3" aria-hidden="true">
                                ...
                                <span class="plan-cost">Free</span>
                                <p><?= (isset($platinum['branch_free_card_plan'])) ? $platinum['branch_free_card_plan'] : '' ; ?></p>
                              </span>
                          </label> 
                        </div>
                    <?php }?>
