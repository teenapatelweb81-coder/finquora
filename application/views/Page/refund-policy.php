...
&quot;) -21.98px;"></div>
	<div class="container">
		<div class="page-title">
			...
			<h1><?php echo !empty($refund_policy['title']) ? $refund_policy['title'] : 'Not yet any policy'; ?> </h1>
		</div>
		<div class="breadcrumb">
			<ul itemscope="" itemtype="https://schema.org/BreadcrumbList">
			  ...
			  <li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem">
			    <a itemprop="item" href="<?= base_url('refund-policy')?>">
			    <span itemprop="name">Cancellation &amp; Refund Policy</span></a>
			...
			<div class="col-lg-12">
				...
				<div class="card">
	                <div class="card-body">
						...
						<?php echo !empty($refund_policy['description']) ? $refund_policy['description'] : 'Not yet any policy'; ?>
					</div>
				</div>
