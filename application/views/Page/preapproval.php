    ...
    font-size: 12px !important;
        ...
        <section>
            ...
            <div class="container agent_container">
                ...
                <?php echo form_open('/userPayment',array('method'=>'post'));?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="credit-card">
                            ...
                            <input name="plan" class="radio" type="radio" value="<?= (isset($data->plan_name)) ? $data->plan_name : '' ; ?>">
                            <input type="hidden" name="plan_amount"  value="<?= (isset($data->amount)) ? $data->amount : '' ; ?>">
                            ...
                            <span class="plan-details p-3 p-3" aria-hidden="true">
                              ...
                              <span class="plan-cost"><?= (isset($data->amount)) ? $data->amount : 0 ; ?>₹

                              <!--<span class="slash">/</span><span class="plan-cycle">mo</span>-->

                              </span>
                              <span >Valid For <?= (isset($data->validity)) ? $data->validity : '' ; ?></span>

                              <p><?= (isset($silver['customer_card_plan'])) ? $silver['customer_card_plan'] : '' ; ?></p>
                        ...
                        <div class="credit-card">
                            ...
                            <input name="plan" class="radio" type="radio" value="<?= (isset($data->plan2_name)) ? $data->plan2_name : '' ; ?>">

                            <span class="hidden-visually"><?= (isset($platinum['card_name'])) ? $platinum['card_name'] : '' ; ?></span>
                             <input type="hidden" name="plan_amount1"  value="<?= (isset($data->amount2)) ? $data->amount2 : '' ; ?>">

                            <span class="plan-details p-3" aria-hidden="true">

                              <span class="plan-type"><?= (isset($platinum['card_name'])) ? $platinum['card_name'] : '' ; ?></span>

                              <span class="plan-cost"><?= (isset($data->amount2)) ? $data->amount2 : 0 ; ?> ₹
                              ...
                              <p><?= (isset($platinum['customer_card_plan'])) ? $platinum['customer_card_plan'] : '' ; ?></p>
                      ...
                      <div class="col-md-6">
                            <label class="card">
                              ...
                              <span class="plan-details p-3 p-3" aria-hidden="true">
                                ...
                                <p><?= (isset($silver['customer_free_card_plan'])) ? $silver['customer_free_card_plan'] : '' ; ?></p>
                              </span>
                          </label> 
                        </div>
                        ...
                        <div class="col-md-6">
                            <label class="card">
                              ...
                              <span class="plan-details p-3 p-3" aria-hidden="true">
                                ...
                                <span class="plan-cost">Free</span>
                                <p><?= (isset($platinum['customer_free_card_plan'])) ? $platinum['customer_free_card_plan'] : '' ; ?></p>
                              </span>
                          </label> 
                        </div>
                    <?php }?>
