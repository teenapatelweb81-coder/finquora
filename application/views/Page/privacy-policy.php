...
&quot;) -19.6px;"></div>
	<div class="container">
		<div class="page-title">
			...
			<h1><?php echo !empty($privacy_policy['title']) ? htmlspecialchars($privacy_policy['title']) : 'Privacy Policy'; ?></h1>
		</div>
		<div class="breadcrumb">
			<ul itemscope="" itemtype="https://schema.org/BreadcrumbList">
			  ...
			  <li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem">
			    <a itemprop="item" href="<?php echo base_url('privacy-policy');?>">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="card">
	                <div class="card-body">
						 <?php echo !empty($privacy_policy['description']) ? $privacy_policy['description'] : 'Not yet any policy'; ?>
