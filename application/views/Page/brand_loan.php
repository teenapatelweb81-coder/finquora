        ...
        <div class="col-lg-10">
            <div class="card shadow-lg">
                  <div class="card-header text-white p-3" style="background-color:<?= isset($heading['color']) ? $heading['color'] :  '#ed940d' ?>">
                    <h3 class="mb-0 text-center"><i class="fas fa-file-invoice-dollar mr-2"></i><?= isset($heading['title']) ? $heading['title'] : 'Brand Loan' ?>   Form</h3>
                </div>
                ...
                <form class="form-horizontal" action="<?= base_url('brand-loan-insert'); ?>" method="post" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="card-footer bg-light p-4 text-center">
                       <button type="reset" class="btn  <?= isset($heading['color']) ? 'btn-dynamic' :  'btn-outline-secondary' ?>    mr-2"><i class="fas fa-redo me-1"></i> Reset</button>
                        <button type="submit" class="btn  <?= isset($heading['color']) ? 'btn-dynamic' :  'btn-primary' ?> px-4">
                            <i class="fas fa-paper-plane mr-2"></i>Submit Brand Loan
                        </button>
                    </div>
                </form>
            </div>
