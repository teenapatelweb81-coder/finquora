...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">Policy  Form</li>
           </ol>
         </nav>
</div>
   ...
   <div class="row">
      <div class="col-md-12 px-0 form-main">
         <div class="card  form-card">
            ...
            <?php echo form_open('admin/add-policy',['id'=>'catfrmm']);?>
            <div class=" row">
                     <div class="col-sm-12">
            ...
            <div class="form-group row">
                 <div class="col-sm-12">
                       <label for="Image Alt Description" class=" col-form-label">Page Content<span class="text-danger">*</span></label>
                        <textarea id="editor" name="policy_content" rows="2" class="form-control"></textarea>
            ...
            <!--   <div class="col-sm-10">-->
            <!--        <input type="text" class="form-control" placeholder="Enter Title" name="metaTitle">                    -->
            <!--    </div>-->
            <!--</div>-->
            ...
            <!--   <div class="col-sm-10">-->
            <!--        <input type="text" class="form-control" placeholder="Enter Meta Tag" name="metaTag">                    -->
            <!--    </div>-->
            <!--</div>-->
