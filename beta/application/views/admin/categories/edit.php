...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">categories  Form</li>
           </ol>
         </nav>
</div>
   ...
   <div class="row">
      <div class="col-md-12 px-0 form-main">
         <div class="card  form-card">
            ...
            <?php echo form_open_multipart('admin/update-categories',['id'=>'sliderfrmm']);?>
    ...
    <?php }?>
                ...
                <div class=" col-md-6  mt-2">
                  ...
                  <input type="text" name="button_name" id="button_name" class="form-control" title="Enter product image" placeholder="Add Sub Title" value="<?= set_value('button_name',$datas->button_name); ?>">
                ...
                <input type="hidden" name="id" value="<?= $datas->id ?>"> 
                  ...
                  <input type="text" name="url" id="url" class="form-control" title="Enter product image" placeholder="Add Sub Title" value="<?= set_value('url',$datas->url); ?>">
