   ...
   <div class="row">
      <div class="col-md-12 px-0 form-main">
         <div class="card  form-card">
            ...
            <?php echo form_open_multipart('admin/add-categories');?>
            ...
            <div class="row">
               ...
               <div class=" col-md-6  mt-2">
                 ...
                 <input type="text" name="sub_title" id="sub_title" class="form-control" title="Enter product image" placeholder="Add Description" >
                
                </div>
                <div class=" col-md-6  mt-2">
                 
                  <label for="Image Alt Description" class=" form-label">Button Name</label>
                  <input type="text" name="button_name" id="button_name" class="form-control" title="Enter product image" placeholder="Add Button Name" >
                     <?php echo form_error('button_name','<span class="text-danger mt-1">','</span>') ;?>
                 </div>
                <div class=" col-md-6  mt-2">
                 
                  <label for="Image Alt Redirection" class=" form-label">Redirection</label>
                  <input type="text" name="url" id="url" class="form-control" title="Enter product image" placeholder="Add Redirection">
            ...
            <div class="form-group">
               ...
               <a href="<?php echo base_url('admin/categories') ;?>" class="btn btn-secondary mt-4">Show</a>
            </div>
            <?php echo form_close();?>
         </div>
      </div>
