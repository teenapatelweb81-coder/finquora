...
<div class="container-fluid">
    <div class="row m-0" >
		<div class="col-md-12 px-0">
		    <div id="" class="text-primary text-right my-2">
                <a href="<?php echo base_url() ?>admin/roles-add" class="btn btn-primary"><i class="fa fa-plus text-light fa-sm" aria-hidden="true"></i> Add</a>
            </div>
    ...
    foreach ($roles as $data) {
        ...
        ?>
					<tr>
						...
						<td class=''><?=$data['permission']?></td>
						<!-- <td class=''><?=$data['user_id']?></td> -->
						

						<td>
                    
					       <a href="<?php echo base_url('admin/roles-edit/') . $data['id']; ?>"><i class="fa fa-pencil-square-o text-primary fa-lg" aria-hidden="true"></i></a>
					        <a href="<?php echo base_url('admin/roles-del/') . $data['id']; ?>" onclick="return confirm('Are you sure ?')" ><i class="fa fa-trash text-danger fa-lg" aria-hidden="true" onclick="delLead"></i></a>
