        ...
        <div class="row">
            <div class="col-md-12 px-0 form-main">
                <div class="card  form-card">
                    ...
                    <?php echo form_open_multipart('admin/important_update-update');?>
    ...
    if ($this->session->userdata('type') == 'admin') { ?>
        ...
        <?php }?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="date" id="date" class="form-control" value="<?= (isset($datas['date'])) ? $datas['date'] : '' ; ?>" required>
                            <?php //echo form_error('first_name','<span class="text-danger mt-1">','</span>') ;?>
                        </div>
                        <div class="col-md-12">
