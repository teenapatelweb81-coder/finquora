                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12"> 
                                <div class="form-group">
                                    <button type="submit" name="save" id="create" value="Save" class="btn btn-info mt-4 mr-3">Powerd by instant loan deals 1 </button>
                                    <button type="submit" name="save"  id="create" value="Save2" class="btn btn-info mt-4">Powerd by instant loan deals 2</button>
                                </div>
                            </div>
                        </div>
                </form>
