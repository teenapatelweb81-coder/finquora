...
<?php
$user = $this->db->where('id', $_GET['user_id'])->get('branch_franchise')->row_array();
if (empty($user)) {
    $user = $this->db->where('id', $_GET['user_id'])->get('user_master')->row_array();
}
?>
    ...
    <div class="row align-items-center">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <h3 class="mb-0"  style="font-weight: 600; font-size: 23px;"> Business Loan</h3>
...
?>
                ...
                <form class="form-horizontal" action="<?=base_url('admin/Home/businessloan_insert?user_id=')?><?=$type?>" method="post" enctype="multipart/form-data">
