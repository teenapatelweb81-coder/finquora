            ...
            <div class="col-md-12 px-0 form-main">
                <div class="card  form-card">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                             ...
                             <input required type="text" name="loan_amount_req" id="loan_amount_req" class="form-control" value="<?= isset($loans['loan_amount_req']) ? $loans['loan_amount_req'] : '';?>" >
                             <input  type="hidden" name="id" class="form-control" value="<?= isset($loans['id']) ? $loans['id'] : '';?>">
                             <input  type="hidden" name="apply_for_loan" class="form-control" value="<?= isset($loans['apply_for_loan']) ? $loans['apply_for_loan'] : '';?>">
                             <input  type="hidden"  class="form-control city" value="<?= isset($loans['city']) ? $loans['city'] : '';?>">
                         </div> 
                         <div class="col-md-3 mb-3">
                         <label for="client_name" class="form-label">Client Name <span class="text-danger">*</span></label>
                             <input required type="text" name="client_name" id="client_name" class="form-control" value="<?= isset($loans['client_name']) ? $loans['client_name'] : '';?>" >
                         
                         </div>
                         <div class="col-md-3 mb-3">
                             <label for="mobile" class="form-label">Mobile No. <span class="text-danger">*</span></label>
                             <input required type="number" name="clientnumber" id="mobile" class="form-control"  value="<?= isset($loans['clientnumber']) ? $loans['clientnumber'] : '';?>" >
                         </div> 
                         <div class="col-md-3 mb-3">
                             <label for="email" class="form-label">Email Id <span class="text-danger">*</span></label>
                             <input required type="email" name="email" id="email" class="form-control"  value="<?= isset($loans['email']) ? $loans['email'] : '';?>">
                         </div> 
                         
                        <div class="col-md-3 mb-3">
                            <label for="dob" class="form-label">Date Of Birth<span class="text-danger">*</span></label>
                            <input required type="text" name="dob" id="name" class="form-control" value="<?= isset($loans['dob']) ? $loans['dob'] : '';?>" >
                        </div> 
                        <div class="col-md-3 mb-3">
                        <label for="pan" class="form-label">Pan No.<span class="text-danger">*</span></label>
                            <input required type="text" name="pan" id="pan" value="<?= isset($loans['pan']) ? $loans['pan'] : '';?>" class="form-control" >
                        
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="aadhar" class="form-label">Aadhar No.<span class="text-danger">*</span></label>
                            <input required type="text" name="aadhar" value="<?= isset($loans['aadhar']) ? $loans['aadhar'] : '';?>" id="aadhar" class="form-control" >
                        </div> 
                        <div class="col-md-3 mb-3">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input required type="text" name="spouse_house" id="spouse_house" value="<?= isset($loans['spouse_house']) ? $loans['spouse_house'] : '';?>" class="form-control" >
                        </div> 
                        <div class="col-md-3 mb-3">
                            <label for="mother_name" class="form-label">Mother Name<span class="text-danger">*</span></label>
                            <input required type="text" name="mother_name" id="mother_name" value="<?= isset($loans['mother_name']) ? $loans['mother_name'] : '';?>" class="form-control" >
                        </div> 
                        <div class="col-md-3 mb-3">
                            <label for="alt_number" class="form-label">Other Contact Name<span class="text-danger">*</span></label>
                            <input required type="text" name="alt_number" id="alt_number" value="<?= isset($loans['mother_name']) ? $loans['mother_name'] : '';?>"  class="form-control" >
                        </div> 
                        <div class="col-md-3 mb-3">
                            <label for="qualification" class="form-label">Qualification<span class="text-danger">*</span></label>
                            <input required type="text" name="qualification" id="qualification" value="<?= isset($loans['qualification']) ? $loans['qualification'] : '';?>" class="form-control" >
                        </div> 
                        <div class="col-md-3 mb-3">
                            <label for="residential_type" class="form-label">Residence Type<span class="text-danger">*</span></label>
                            <input required type="text" name="residential_type" id="residential_type" value="<?= isset($loans['residential_type']) ? $loans['residential_type'] : '';?>" class="form-control" >
                        </div> 
                        <div class="col-md-3 mb-3">
                            <label for="residential_address" class="form-label">Residential Address <span class="text-danger">*</span></label>
                            <input required type="text" name="residential_address" id="residential_address" value="<?= isset($loans['residential_address']) ? $loans['residential_address'] : '';?>" class="form-control" >
                        </div> 
                        <div class="col-md-3 mb-3">
                            <label for="residential_address_token" class="form-label">Residential Address Token Form<span class="text-danger">*</span></label>
                            <input required type="text" name="residential_address_token" id="residential_address_token" value="<?= isset($loans['residential_address_token']) ? $loans['residential_address_token'] : '';?>" class="form-control" >
                        </div> 
                        <div class="col-md-3 mb-3">
                            <label for="residence_stability" class="form-label">Residence Stability<span class="text-danger">*</span></label>
                            <input required type="text" name="residence_stability" id="residence_stability" value="<?= isset($loans['residence_stability']) ? $loans['residence_stability'] : '';?>" class="form-control" >
                        </div> 
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input required type="text" name="pin_code" id="pin_code" value="<?= isset($loans['pin_code']) ? $loans['pin_code'] : '';?>" class="form-control" >
                        </div> 
                        <div class="col-md-3 mb-3">
                            <label for="company_name" class="form-label">Company Name<span class="text-danger">*</span></label>
                            <input required type="text" name="company_name" id="company_name" value="<?= isset($loans['company_name']) ? $loans['company_name'] : '';?>" class="form-control" >
                        </div> 

                        <div class="col-md-3 mb-3">
                            <label for="designation" class="form-label">Designation<span class="text-danger">*</span></label>
                            <input required type="text" name="designation" id="designation" value="<?= isset($loans['designation']) ? $loans['designation'] : '';?>" class="form-control" >
                        </div> 
                        <div class="col-md-3 mb-3">
                            <label for="company_address" class="form-label">Company Address<span class="text-danger">*</span></label>
                            <input required type="text" name="company_address" id="company_address" value="<?= isset($loans['company_address']) ? $loans['company_address'] : '';?>" class="form-control" >
                        </div> 
                        <div class="col-md-3 mb-3">
                            <label for="company_address" class="form-label">Net Salary<span class="text-danger">*</span></label>
                            <input required type="text" name="net_salary" id="net_salary" value="<?= isset($loans['net_salary']) ? $loans['net_salary'] : '';?>" class="form-control" >
                        </div> 
                        <div class="col-md-3 mb-3">
                            <label for="salary_transfer_mode" class="form-label">Salary Transfer Mode<span class="text-danger">*</span></label>
                            <input required type="text" name="salary_transfer_mode" id="salary_transfer_mode" value="<?= isset($loans['salary_transfer_mode']) ? $loans['salary_transfer_mode'] : '';?>" class="form-control" >
                        </div> 
                        <div class="col-md-3 mb-3">
                            <label for="job_period" class="form-label">Job Period (Current Company) <span class="text-danger">*</span></label>
                            <input required type="text" name="job_period" id="job_period" value="<?= isset($loans['job_period']) ? $loans['job_period'] : '';?>" class="form-control" >
                        </div> 
                        <div class="col-md-3 mb-3">
                            <label for="job_experience" class="form-label">Total Job Experience<span class="text-danger">*</span></label>
                            <input required type="text" name="job_experience" id="job_experience" value="<?= isset($loans['salary_transfer_mode']) ? $loans['salary_transfer_mode'] : '';?>" class="form-control" >
                        </div> 
                        <div class="col-md-3 mb-3">
                            <label for="ofc_email" class="form-label">Office Email ID<span class="text-danger">*</span></label>
                            <input required type="text" name="ofc_email" id="ofc_email" value="<?= isset($loans['ofc_email']) ? $loans['ofc_email'] : '';?>" class="form-control" >
                        </div> 
                        <div class="col-md-3 mb-3">
                            <label for="ofc_number" class="form-label">Office Number<span class="text-danger">*</span></label>
                            <input required type="text" name="ofc_number" id="ofc_number" value="<?= isset($loans['ofc_number']) ? $loans['ofc_number'] : '';?>" class="form-control" >
                        </div> 

                        <div class="col-md-3 mb-3">
                            <label for="no_of_dependent" class="form-label">No of Dependent<span class="text-danger">*</span></label>
                            <input required type="text" name="no_of_dependent" value="<?= isset($loans['no_of_dependent']) ? $loans['no_of_dependent'] : '';?>" id="no_of_dependent" class="form-control" >
                        </div> 
                        <div class="col-md-3 mb-3">
                            <label for="cc_outstanding_amount" class="form-label">Credit Card Outstanding Amount<span class="text-danger">*</span></label>
                            <input required type="text" name="cc_outstanding_amount" value="<?= isset($loans['cc_outstanding_amount']) ? $loans['cc_outstanding_amount'] : '';?>" id="cc_outstanding_amount" class="form-control" >
                        </div> 
                    </div>
                ...
                <div class="form-group row align-items-end" > 
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <input required type="text" name="ref_name1" value ="<?= isset($loans['ref_name1']) ? $loans['ref_name1'] : '';?>" id="name" class="form-control" ="">
                        </div> 
                        <div class="col-md-4 mb-4">
                            <label for="mobile" class="form-label">Mobile No. <span class="text-danger">*</span></label>
                            <input required type="number" name="ref_mobile1"value ="<?= isset($loans['ref_mobile1']) ? $loans['ref_mobile1'] : '';?>" id="mobile" class="form-control" ="">
                        </div> 
                        <div class="col-md-4 mb-4">
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <input required type="text" name="ref_name2" value ="<?= isset($loans['ref_name2']) ? $loans['ref_name2'] : '';?>" id="rname" class="form-control" ="">
                        </div> 
                        <div class="col-md-4 mb-4">
                            <label for="mobile_no" class="form-label">Mobile No. <span class="text-danger">*</span></label>
                            <input required type="number" name="ref_mobile2" value ="<?= isset($loans['ref_mobile2']) ? $loans['ref_mobile2'] : '';?>" id="mobile_no" class="form-control" ="">
                        </div> 
                        <div class="col-md-4 mb-4">
                            <label for="relation" class="form-label">Relation <span class="text-danger">*</span></label>
