...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">Business loan view</li>
           </ol>
         </nav>
</div>
                    ...
                    <?php if ($this->session->userdata('role') == 1) {?>
                        <div class="col-md-12 text-right mb-3">
                            <div class="copy-text d-flex align-items-center justify-content-end">
                                    <input type="text" class="text py-1 px-2 form-control w-25 readonly" id="myInput" value="<?=base_url('web_pages/share/cpsess1101506595/')?><?=$loans['id']?>" />
    ...
    foreach ($states as $key => $state) {?>
                ...
                <div class="form-group row align-items-end" >
                        ...
                        <div class="col-md-12 mb-12" style="background-color:#fed8b1;">
                            <label for="References" class="form-label py-2 mb-0 pl-1">Upload Documents  <span class="text-danger">*</span></label>
                        </div>
                    </div>
                 ...
                 <div class="customer_records_dynamicss"></div>
                  <div class="col-md-2 mb-3 text-left">
                        ...
                        <div class="col-md-12 pb-3 mb-3 px-0" style="border-bottom: 1px solid #0000004a;">
                            <table class=" table-bordered text-center table-hover w-100 px-0 mb-4" id="dtBasicExample">
                     ...
                     <!-- <div class="form-group row align-items-center">
                            ...
                            <button type="submit" class="btn btn-primary" style="background-color:#325f9a;">Upload</button>
                            </div>
                        </div> -->
                ...
                <div class="col-md-12 mb-3" style="background-color:#fed8b1;">
                    <label for="References" class="form-label py-2 mb-0 pl-1" >For Remarks And lead status</label>
                </div>
                    ...
                    <div class="form-group row align-items-end" style="margin-bottom:0 !important;">
                        <div class="col-md-4 mb-3">
                          <label for="loan_status" class="form-label">Loan Status</label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="bank_for_admin" class="form-label">Assign RM </label>
