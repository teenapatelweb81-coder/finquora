...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">Share Page Credit</li> 
           </ol>
         </nav>
</div>
        ...
        <div class="row">
            <div class="col-md-12 px-0 form-main">
                <div class="card  form-card">
                    ...
                    <form action = "<?= base_url('admin/Home/credit_Update')?>" method="post">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="hidden" name="id"  value="<?= $loans['id']?>"  id="apply_for_loan" class="form-control">
                            </div> 
                            <div class="col-md-4 mb-3">
                            <label for="client_name" class="form-label">Pin Code <span class="text-danger">*</span></label>
                                <input type="number" name="creditPincode" id="creditPincode" class="form-control" value="<?= $loans['creditPincode']?>" required>
