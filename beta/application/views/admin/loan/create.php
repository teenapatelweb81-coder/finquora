...
<div class="card">
  ...
  <div class="card-header bg-white border-0">
    <div class="row align-items-center">
        <div class="col-8">
            <h3 class="mb-0" style="font-size: 23px;">Add Personal Loan</h3>
        </div>
        ...
        <div class="col-4 text-right">
            ...
            <div class="d-flex justify-content-end for_qr">
                <a  class="btn btn-primary mr-2" href="<?php echo base_url('admin/dashboard/qr_code?user_id='); ?><?=$this->session->userdata('user_id')?>&type=pl"  title="You can copy link and Qr Genrate"> Personal Loan Apply Link</a>
...
?>
                <form class="form-horizontal" action="<?=base_url('admin/Dashboard/loan_lead_add?user_id=')?><?=$type?>" method="post" enctype="multipart/form-data">
