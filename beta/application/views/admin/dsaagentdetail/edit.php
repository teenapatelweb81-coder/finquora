        ...
        <div class="row">
            <div class="col-md-12 px-0 form-main">
                <div class="card  form-card">
                    ...
                    <?php echo form_open_multipart('admin/dsaagentdetail-update');?>
                    <span class="text-center text-info mb-2" id="susid"> <?php echo $this->session->flashdata('success'); ?></span>
                <span class="text-center text-danger mb-2" id="errid"> <?php echo $this->session->flashdata('error'); ?></span>
                    
                    <div class="row">
                        <input type="hidden" name="id" id="uid" class="form-control" value="<?= (isset($dsaagentdetail['id'])) ? $dsaagentdetail['id'] : '' ; ?> " >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="leftheading" id="heading" class="form-control" value="<?= (isset($dsaagentdetail['leftheading'])) ? $dsaagentdetail['leftheading'] : '' ; ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input  type="text"  name="rightheading" id="rightheading" class="form-control" required value="<?= (isset($dsaagentdetail['rightheading'])) ? $dsaagentdetail['rightheading'] : '' ; ?> " >
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="description" id="description" class="form-control" required><?= (isset($dsaagentdetail['description'])) ? $dsaagentdetail['description'] : '' ; ?> </textarea>
                        </div>
                        <div class="col-md-6">
                            <label for="description" class="form-label">Left description<span class="text-danger">*</span></label>
                            <textarea name="leftdescription" id="leftdescription" class="form-control" required><?= (isset($dsaagentdetail['leftdescription'])) ? $dsaagentdetail['leftdescription'] : '' ; ?> </textarea>
                        </div>

                        <div class="col-md-6">
                            <label for="description" class="form-label">Right description<span class="text-danger">*</span></label>
                            <textarea name="rightdescription" id="rightdescription" class="form-control" required><?= (isset($dsaagentdetail['rightdescription'])) ? $dsaagentdetail['rightdescription'] : '' ; ?> </textarea>
                            <?php //echo form_error('description','<span class="text-danger mt-1">','</span>'); ?>
                        </div>
                            ...
                            <?php if (isset($dsaagentdetail['image']) && !empty($dsaagentdetail['image'])): ?>
                                ...
                                ?>
                                    <div class="d-inline-block position-relative me-2 mb-2">
                                        ...
                                        <button type="button" class="btn-close position-absolute top-0 end-0 remove-image-btn btn btn-danger" 
...
$(document).ready(function() {
    ...
    $('.remove-image-btn').on('click', function() {
        ...
        if(confirm('Are you sure you want to delete this image?')) {
            $.ajax({
                url: '<?= base_url("admin/deleteDsaAgentImage") ?>',
                type: 'POST',
                data: { 
                    domain_id: <?= (isset($dsaagentdetail['domain_id'])) ? $dsaagentdetail['domain_id'] : '' ; ?>,
                    id: <?= (isset($dsaagentdetail['id'])) ? $dsaagentdetail['id'] : '' ; ?>,
                    image_path: imgPath,
