         ...
         <?php 
            ...
            ?>
               <div _ngcontent-mir-c194="" class="col-md-12">
                  ...
                  <div _ngcontent-mir-c194="" class="row">
                     <div _ngcontent-mir-c194="" class="col-sm-3"><label _ngcontent-mir-c194=""> URL  :</label></div>
                     <div _ngcontent-mir-c194="" class="col-sm-6 h4 font-weight-bold mb-0" ><input type="text" id='number' value="<?= $data->link?>" class="form-control w-75 mb-3 voter d-inline" disabled> <i class="fa fa-copy btn btn-success" style="cursor:pointer;" aria-hidden="true" onclick="userName('<?= $data->link ?>')"></i>
                    </div>
                  </div>
...
function userName(url) {
    ...
    alert('URL Id copied to clipboard : ' + url);
}
