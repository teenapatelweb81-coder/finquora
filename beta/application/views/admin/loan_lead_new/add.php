...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">Add Bank wish login</li>
           </ol>
         </nav>
</div>
                    ...
                    <div class="col-sm-4">
                     ...
                     <div class="col-sm-4">
                        <div class="form-group">
            				...
            				<input type="type" class="form-control" aria-required="true" name="bank_name" placeholder= "Bank name" id="username" required>
            		    </div>
                  </div>
