...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">silver section 3 list</li>
           </ol>
         </nav>
</div>
<div class="container-fluid p-0">
		...
		<div class="col-md-12 p-0">
              ...
              <div class="table-responsive ">
                <div id="" class="text-primary text-right mr-2 mt-2">
                    <a href="<?php echo base_url() ?>admin/silver-section-3-add" class="btn btn-primary"><i class="fa fa-plus text-light fa-sm" aria-hidden="true"></i> Add</a>
        ...
        ?>
					<tr>
						...
						<td>
					       ...
					       <a href="<?php echo base_url('admin/silver-section-3-edit/') . $data['id']; ?>"><i class="fa fa-pencil-square-o text-primary fa-lg" aria-hidden="true"></i></a>
					        <a href="<?php echo base_url('admin/silver-section-3-del/') . $data['id']; ?>" onclick="return confirm('Are you sure ?')" ><i class="fa fa-trash text-danger fa-lg" aria-hidden="true" onclick="delLead"></i></a>
