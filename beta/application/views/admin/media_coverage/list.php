    ...
    <div class="row">
		<div class="col-md-12">
		    ...
		    <div id="" class="text-primary text-right mb-3">
                <a href="<?php echo base_url() ?>admin/media-coverage-add" class="btn btn-primary"><i class="fa fa-plus text-light fa-sm" aria-hidden="true"></i> Add</a>
			...
			<table class="table table-bordered text-center table-hover" >
				...
				<tbody id="leadBody">
					...
					<tr>
						...
						<td class=''><?=$data['heading']?></i></td>
                        <td class=''>
                            <img src="<?= base_url('assets/images/media_coverage/'.$data['image']) ?>" alt="Image" width="100">
                        </td>

						
						<td>
                    
					       <a href="<?php echo base_url('admin/media-coverage-edit/') . $data['id']; ?>"><i class="fa fa-pencil-square-o text-primary fa-lg" aria-hidden="true"></i></a>
					        <a href="<?php echo base_url('admin/media-coverage-del/') . $data['id']; ?>" onclick="return confirm('Are you sure ?')" ><i class="fa fa-trash text-danger fa-lg" aria-hidden="true" onclick="delLead"></i></a>
