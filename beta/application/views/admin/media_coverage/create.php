...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">Add Media Coverage</li> 
           </ol>
         </nav>
</div>
        ...
        <div class="row">
            <div class="col-md-12 px-0 form-main">
                <div class="card  form-card">
                    ...
                    <?php echo form_open_multipart('admin/media-coverage-create');?>
                    <form method="POST" enctype="multipart/form-data" action="<?php echo site_url('admin/media-coverage-create'); ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="text" id="text" class="form-control" value="<?php if(!empty($datas) && $datas['text']){ echo $datas['text'];} ?>" required>
                            <?php //echo form_error('first_name','<span class="text-danger mt-1">','</span>') ;?>
                        </div>
