...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">Edit Joining Letter</li> 
           </ol>
         </nav>
</div>
        ...
        <div class="row">
            <div class="col-md-12 px-0 form-main">
                <div class="card  form-card">
                    ...
                    <?php echo form_open_multipart('admin/joining-letter-update');?>
                ...
                <span class="text-center text-danger mb-2" id="errid"> <?php echo $this->session->flashdata('error'); ?></span>
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="id" id="uid" class="form-control" value=" <?= (isset($joiningLetter['id'])) ? $joiningLetter['id'] : '' ; ?>" >
                    </div>

                        <!-- <div class="col-md-12">
                            <label for="description" class="form-label">Description<span class="text-danger">*</span></label>
                            <textarea name="description" id="description" class="form-control" required><?php echo $joiningLetter['description']; ?></textarea>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label for="image" class="form-label">Signature Image<span class="text-danger">*</span></label>
                            <input type="file" name="image" id="image" class="form-control" <?php if(empty($joiningLetter['image'])){ ?> required <?php } ?> >
                            <?php if(!empty($joiningLetter['image'])){ ?>
                            <img src="<?= base_url('assets/images/joiningLetter/'.$joiningLetter['image']) ?>" alt="Image" width="100">
                            <?php } ?>
                            <?php //echo form_error('description','<span class="text-danger mt-1">','</span>'); ?>
                        </div>

                        <div class="col-md-6">
                            <label for="ceal" class="form-label">Seal Image<span class="text-danger">*</span></label>
                            <input type="file" name="ceal" id="ceal" class="form-control" <?php if(empty($joiningLetter['ceal'])){ ?> required <?php } ?> >
                            <?php if(!empty($joiningLetter['ceal'])){ ?>
                            <img src="<?= base_url('assets/images/joiningLetter/'.$joiningLetter['ceal']) ?>" alt="Ceal Image" width="100">
                            <?php } ?>
                            <?php //echo form_error('description','<span class="text-danger mt-1">','</span>'); ?>
                        </div>
