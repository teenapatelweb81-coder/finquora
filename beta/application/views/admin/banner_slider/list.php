    ...
    <div class="row m-0">
		<div class="col-md-12 mt-4  pt-2 shadow-lg">
		    ...
		    <div id="" class="text-primary text-right mr-3">
                <a href="<?php echo base_url() ?>admin/banner-slider-add" class="btn btn-primary mb-2"><i class="fa fa-plus text-light fa-sm" aria-hidden="true"></i> Add</a>
			...
			<table class="table table-bordered text-center table-hover" >
				...
				<tbody id="leadBody">
					...
					<tr>
                        ...
                        <td class=''>
                            <img src="<?= base_url('assets/images/banner_slider/'.$data['image']) ?>" alt="Image" width="100">
                        </td>

						<td>
                    
					       <a href="<?php echo base_url('admin/banner-slider-edit/') . $data['id']; ?>"><i class="fa fa-pencil-square-o text-primary fa-lg" aria-hidden="true"></i></a>
					        <a href="<?php echo base_url('admin/banner-slider-del/') . $data['id']; ?>" onclick="return confirm('Are you sure ?')" ><i class="fa fa-trash text-danger fa-lg" aria-hidden="true" onclick="delLead"></i></a>
