<?php 
   $user = $this->db->where(array('id' => $_GET['type'] , 'role' => $_GET['role']))->get('branch_franchise')->row_array();
   if(empty($user)){
      $user = $this->db->where(array('id' => $_GET['type'] , 'role' => $_GET['role']))->get('user_master')->row_array();
   }
...
<div class="container-fluid p-0">
   <div class="row" style="margin-top: 100px;color: #000;">
   ...
   <div class="row">
      <div class="col-md-12 px-0 form-main">
         <div class="card  form-card">
            ...
            <?php echo form_open_multipart('admin/send-otp-share?type='.$_GET['type'].'&role='.$_GET['role']);?>
            ...
            <div class="col-md-6 pr-0">
                     ...
                     <nav aria-label="breadcrumb">
                        <ol class="breadcrumb ">
                           <li class="breadcrumb-item active text-dark" aria-current="page">Add Team Member</li>
                        </ol>
                     </nav>
                  </div>
                  <div class="col-md-6 text-user-sm pl-0" 
