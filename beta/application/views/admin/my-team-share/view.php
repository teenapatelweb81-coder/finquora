                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <a href="<?php echo base_url('admin/add-member');?>" style="float: right;"><button type="button" class="btn btn-primary" >Add Member</button></a>
                        </div>
			...
			<table class=" table-bordered text-center table-hover" id="dtBasicExample">
				...
				<tbody id="networkBody">
					...
					<tr>
						...
						<td class=''>₹<?php echo ucwords($data->payout); ?></td>
                        ...
                        <td>
					        <a href="<?php echo base_url('admin/Dashboard/teamMember/').$data->id;?>?ref=my-team">View <i class="fa fa-eye text-primary fa-lg" aria-hidden="true"></i></a>
						<td>
