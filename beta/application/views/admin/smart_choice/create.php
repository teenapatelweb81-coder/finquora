        ...
        <div class="row">
            <div class="col-md-12 px-0 form-main">
                <div class="card  form-card">
                    ...
                    <?php echo form_open_multipart('admin/smart-choice-create');?>
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="title" id="date" class="form-control" required>
                            <?php //echo form_error('first_name','<span class="text-danger mt-1">','</span>') ;?>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="icon" id="title" class="form-control" required>
