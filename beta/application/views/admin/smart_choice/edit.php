         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page"> Smart Choice</li> 
            </ol>
         </nav>
</div>
        ...
        <div class="row m-0">
            <div class="col-md-12 px-0 form-main">
                <div class="card  form-card">
                    ...
                    <?php echo form_open_multipart('admin/smart-choice-update');?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label for="first_name" class="form-label">Text<span class="text-danger">*</span></label>
                            <input type="text" name="text" id="date" class="form-control" value="<?php echo $datas->text;?>" required>
                            <?php //echo form_error('first_name','<span class="text-danger mt-1">','</span>') ;?>
                        </div>
                        <div class="col-md-6">
                            <label for="first_name" class="form-label">Icon<span class="text-danger">*</span></label>
                            <input type="text" name="icon" id="date" class="form-control" value="<?php echo $datas->icon;?>" required>
                            <?php //echo form_error('first_name','<span class="text-danger mt-1">','</span>') ;?>
                        </div>
