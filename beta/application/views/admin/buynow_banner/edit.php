        ...
        <div class="row">
            <div class="col-md-12 px-0 form-main">
                <div class="card  form-card">
                    ...
                    <?php echo form_open_multipart('admin/buynow-banner-update');?>
                    <span class="text-center text-info mb-2" id="susid"> <?php echo $this->session->flashdata('success'); ?></span>
                <span class="text-center text-danger mb-2" id="errid"> <?php echo $this->session->flashdata('error'); ?></span>
                    
                    <div class="row">
                        <input type="hidden" name="id" id="uid" class="form-control" value="<?= isset($buynowBanner['id']) ? $buynowBanner['id'] : '';?>" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="title" id="title" class="form-control" value="<?= isset($buynowBanner['title']) ? $buynowBanner['title'] : '';?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="text" id="text" class="form-control" required value="<?= isset($buynowBanner['text']) ? $buynowBanner['text'] :"" ; ?>" >
                            <?php //echo form_error('description','<span class="text-danger mt-1">','</span>'); ?>
                        </div>
                        <div class="col-md-12">
                            <label for="description" class="form-label">Description<span class="text-danger">*</span></label>
                            <textarea name="description" id="description" class="form-control" required><?= isset($buynowBanner['description']) ? $buynowBanner['description'] :"" ; ?></textarea>
                            <?php //echo form_error('description','<span class="text-danger mt-1">','</span>'); ?>
                        </div>
