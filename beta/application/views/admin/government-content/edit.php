...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">Government Content Edit</li> 
           </ol>
         </nav>
</div>
        ...
        <div class="row">
            <div class="col-md-12 px-0 form-main">
                <div class="card  form-card">
                    ...
                    <?php echo form_open_multipart('admin/government-content-update');?>
                        ...
                        <div class="col-md-4 mb-2">
                            ...
                            <select class="form-control" id="pags" name="menu_id" required>
                                ...
                                <?php foreach ($menus as $menu): ?>
                                    <option <?=  ($menu['id'] == $datas->menu_id) ? 'selected' :'' ;?> value="<?= $menu['id'] ?>"><?= $menu['url'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-md-12">
