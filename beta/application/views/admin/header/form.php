   ...
   <div class="row">
      <div class="col-md-12 px-0 form-main">
         <div class="card  form-card">
            ...
            <?php echo form_open_multipart('admin/save_menu');?>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-2">
                    <label for="redirect" class="form-label">Redirect</label>
                      <input type="text" name="url" id="redirect" class="form-control" value="<?= set_value('url'); ?>" placeholder="Enter redirection url">

                    <?php echo form_error('title','<span class="text-danger mt-1">','</span>') ;?>
               </div>
               
               <div class=" col-md-6  mt-2">
                  <label for="Image Alt Description" class=" form-label">Parent Menu</label>
