...
<div class="container-fluid px-0">
		...
		<div class="cart-b">
			<div class="row align-items-end">
				<div class="col-md-3 mt-2 ">
					...
					<input type="hidden" name="type" value="marketing_whatsapp">
    ...
    <div id="message" class="text-primary text-center"></div>
		<a href="<?php echo base_url('admin/add-whatsapp-transfer') ;?>" class="btn btn-primary float-right mb-3"><i class="fa fa-plus" aria-hidden="true"></i> Add Marketing WhatsApp Links </a>
			...
			<table class="table table-bordered text-center table-hover shadow-lg">
				...
				<tbody>
					...
					<tr>
						...
						<td class=''>
					   <a href="<?php echo base_url('admin/edit-whatsapp-transfer/').$data->id;?>"><i class="fa fa-pencil-square-o text-warning fa-lg" aria-hidden="true"></i></a>
					   <a href="<?php echo base_url('admin/delete-whatsapp-transfer/').$data->id;?>"><i class="fa fa-trash text-danger fa-lg" aria-hidden="true"></i></a> 
						</td>
					</tr>
				   <?php $num++;  }} ?>
				</tbody>
    ...
    $(document).on('click','.status_checks',function() {
        ...
        var newstatus = (status=='0')? '1':'0';
         if(confirm("Are you sure to "+ msg)) {
                  $.ajax({
                  type:"POST",
                  url: "<?= base_url('admin/update-whatsapp-status-transfer'); ?>", 
