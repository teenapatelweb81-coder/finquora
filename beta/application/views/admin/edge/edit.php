...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">Edge  Form</li>
           </ol>
         </nav>
</div>
   ...
   <div class="row">
      <div class="col-md-12 px-0 form-main">
         <div class="card  form-card">
            ...
            <?php echo form_open_multipart('admin/update-edge',['id'=>'sliderfrmm']);?>
            ...
            <div class="row">
                 <div class="form-group col-md-6 mt-4">
                     ...
                     <label for="Image Alt Description" class=" col-form-label">Edge Image(Upload size Max 2 MB)</label>
