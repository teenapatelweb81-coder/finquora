                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <a href="<?php echo base_url('admin/add-network-member');?>" style="float: right;"><button type="button" class="btn btn-primary" >Add Network Member</button></a>
                        </div>
				...
				<tbody id="networkBody">
					...
					<tr>
						...
						<td class=''><?php  if ($data->status == 1) {echo 'Active';} else {echo 'Inactive';} ?></td>
                         ...
                         <?php 
                                $plan = $this->db->where('id',5)->get('plan_tbl')->row();

                                $amount ='';
                            if ($data->subscription == 'Plantinum') {
                              $amount = $plan->amount2;
                            }elseif($data->subscription == 'Silver'){
                                $amount = $plan->amount;
                            }
                         ?>
