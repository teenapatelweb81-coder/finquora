 <section class="profile-content">
            ...
            <div class="profile-bio card form-card">
                ...
                <!------------------------ User OTP screen  Starts ------------------------->
                    <div class=" m-0 p-10" id="second" style="display: flex;flex-direction: row;justify-content: center;">
     ...
     <script>
       ...
       $('#submitForm2').submit(function (e) {
        ...
        if(otpcode === otp) {
            ...
            $.ajax({
                    type: 'post',
                    url: "<?php echo base_url('/admin/create-network-member-share?type=' . $_GET['type']).'&role='.$_GET['role']; ?>",
                    data: regData,
                    success: function (response) {
                        ...
                        if(obj.status == "true") {
                            if(role == "user") {
                                window.location.href = "<?php echo base_url('/admin/network-member-plan-share?type=' . $_GET['type']).'&role='.$_GET['role']; ?>";
                            }
                            else {
                                window.location.href = "<?php echo base_url('/admin/network-member-plan-share?type=' . $_GET['type']).'&role='.$_GET['role']; ?>";
                            }
