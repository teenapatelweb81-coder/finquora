        ...
        <div class="row">
            <div class="col-md-12 px-0 form-main">
                <div class="card  form-card">
                    ...
                    <?php echo form_open_multipart('admin/buynow-section-update');?>
                    <span class="text-center text-info mb-2" id="susid"> <?php echo $this->session->flashdata('success'); ?></span>
                <span class="text-center text-danger mb-2" id="errid"> <?php echo $this->session->flashdata('error'); ?></span>
                    
                    <div class="row">
                        <input type="hidden" name="id" id="uid" class="form-control" value="<?= isset($buynowSection['id']) ? $buynowSection['id'] : '';?>" >
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="title" id="title" class="form-control" value="<?= isset($buynowSection['title']) ? $buynowSection['title']:'';?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="text" id="text" class="form-control" required value="<?= isset($buynowSection['text']) ? $buynowSection['text']:''; ?>" >
