        ...
        <div class="row m-0">
            <div class="col-md-12 px-0 form-main">
                <div class="card  form-card">
                    ...
                    <?php echo form_open_multipart('admin/loan-type-master-update');?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="loan_name" id="name" class="form-control" value="<?php echo $datas->loan_name;?>" required>
