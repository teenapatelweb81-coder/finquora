...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">Loan Type Master</li>
            </ol>
         </nav>
</div>
    ...
    <div class="row m-0">
		<div class="col-md-12 px-0">
		    ...
		    <div id="" class="text-primary text-right mb-2">
                <a href="<?php echo base_url()?>admin/loan-type-master-add" class="btn btn-primary mr-2"><i class="fa fa-plus text-light fa-sm" aria-hidden="true"></i> Add</a>
			...
			<table class=" table-bordered text-center table-hover" id="dtBasicExample"> 
				...
				<tbody id="leadBody">
					...
					foreach($banker as $data) {
                        ...
                        $bankName = $this->db->where('id',$data->id)->get('tbl_banks')->row('bank_name');
                        ?> 
					<tr>
						<td class=''><?php echo $num; ?></td>						
						<td class=''><?= $data->loan_name ?></td>			
						 <?php if($this->session->userdata('role') == 1){ ?>
						<td>
                        <!-- -->
					       <a href="<?php echo base_url('admin/loan-type-master-edit/').$data->id;?>"><i class="fa fa-pencil-square-o text-primary fa-lg" aria-hidden="true"></i></a>
					        <a href="<?php echo base_url('admin/Dashboard/loan_type_master_del/').$data->id;?>" onclick="return confirm('Are you sure ?')" ><i class="fa fa-trash text-danger fa-lg" aria-hidden="true" onclick="delLead"></i></a>
