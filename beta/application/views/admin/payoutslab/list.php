...
<div class="container-fluid p-0">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb ">
      ...
      <li class="breadcrumb-item active" aria-current="page">Payout slab unsecured loans</li>
    </ol>
  </nav>
</div>
...
<div class="container-fluid px-0">
  <div class="row m-0">
    <div class="col-md-12 px-0 bg-white">
      ...
      <div class="d-flex mt-1 mr-1 align-items-center justify-content-end">
...
$('#deleteSelectedBtn').on('click', function() {
    ...
    $.ajax({
        url: "<?= base_url('admin/payoutslab-bulk-delete'); ?>",
        type: "POST",
        data: { ids: ids },
