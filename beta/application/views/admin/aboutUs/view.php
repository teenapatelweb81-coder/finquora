...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">About Us Data</li>
           </ol>
         </nav>
</div>
<div class="container">
	<div class="row">
		<div class="col-md-12 px-0">
			...
			<!--<a href="<?php echo base_url('admin/add-policy') ;?>" class="btn btn-primary float-right mb-3"><i class="fa fa-plus" aria-hidden="true"></i>Add Policy Data</a>-->
			...
			<table class="table table-bordered text-center table-hover shadow-lg">
				...
				<tbody>
					...
					<tr>
						...
						<td class=''><?php echo ucwords($data->firstData); ?></td>
						...
						<td class=''>
					   <a href="<?php echo base_url('admin/edit-about-us/').$data->id;?>"><i class="fa fa-pencil-square-o text-warning fa-lg" aria-hidden="true"></i></a>
					   <!--<a href="<?php echo base_url('admin/delete-policy/').$data->id;?>" ><i class="fa fa-trash text-danger fa-lg" aria-hidden="true"></i></a> -->
						</td>
					</tr>
				   <?php $num++;  } } else {?>
				   <tr><td colspan="5">About Us Data not available.</td></tr>
				   <?php }?>
				</tbody>
			</table>
			</div>
    ...
    $(document).on('click','.status_checks',function() {
        ...
        var newstatus = (status=='0')? '1':'0';
         if(confirm("Are you sure to "+ msg)) {
                  $.ajax({
                  type:"POST",
                  url: '<?= base_url('admin/update_aboutus_status'); ?>', 
