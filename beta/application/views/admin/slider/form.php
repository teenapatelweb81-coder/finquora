            ...
            <div class="row">
               ...
               <div class="col-md-6 mt-2">
                  ...
                  <div class="input-group">
                     <input type="text" name="text_color" id="text_color" class="form-control" placeholder="Add text color" value="<?= set_value('text_color'); ?>">
                     <input type="color" id="text_color_picker" class="form-control form-control-color" value="<?= set_value('text_color') ? set_value('text_color') : '#000000'; ?>">
                  </div>
