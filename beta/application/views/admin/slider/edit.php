            ...
            <div class="row">
               ...
               <?php
                ...
                <div class=" col-md-6 mt-2">
                  ...
                  <input type="text" name="button_name" id="button_name" class="form-control" title="Enter product image" placeholder="Add button name" value="<?= set_value('button_name',$datas->button_name); ?>">
                 ...
                 <div class="col-md-6 mt-2">
                  ...
                  <div class="input-group">
                     ...
                     <input type="color" id="button_color_picker" class="form-control form-control-color" value="<?= set_value('button_color',$datas->button_color) ? set_value('button_color',$datas->button_color) : '#0d6efd'; ?>">
                  </div>
                  <?php echo form_error('button_color','<span class="text-danger mt-1">','</span>'); ?>
               </div>
                <div class=" col-md-6 mt-2">
                 
                  <label for="Image Alt Description" class=" form-label"> Redirection</label>
                  <input type="text" name="url" id="url" class="form-control" title="redirection" placeholder="Add url" value="<?= set_value('url',$datas->url); ?>">
                     <?php echo form_error('url','<span class="text-danger mt-1">','</span>') ;?>
                 </div>
            </div>
            <div class="row">
                 <div class="form-group col-md-6 mt-4">
                     <img src="<?= base_url('assets/images/slider/').$datas->slider_image ?>" style="width:30px; height:30px;"> 
                 ...
                 <div class="form-group col-md-6 mt-4">
                     <img src="<?= base_url('assets/images/slider/').$datas->bg_image ?>" style="width:30px; height:30px;"> 
                     <label for="Image Alt Description" class=" col-form-label">Slider Background Image(Upload size Max 2 MB)</label>
                     <input type="file" name="bg_image" id="bg_image" class="form-control" title="Enter product image" placeholder="Add Catogery image" >
                     <span class="text-center text-danger mb-2" id="errid"> <?php  echo $this->session->flashdata('imgerror');?></span>
                 </div>
                  <input type="hidden" name="id" value="<?= $datas->id ?>"> <input type="hidden" name="old_bg_img" value="<?= $datas->bg_image ?>">
                  <input type="hidden" name="old_img" value="<?= $datas->slider_image ?>">
            </div>
