    ...
    <div class="row m-0 bg-white">
		<div class="col-md-12 px-0">
		    ...
		    <div id="" class="text-primary text-right">
                ...
                <a href="<?php echo base_url() ?>admin/sub-admin-add" class="btn btn-primary mr-1"><i class="fa fa-plus text-light fa-sm" aria-hidden="true"></i> Add</a>
        ...
        ?>
					<tr>
						...
						<td class=''><?=$data['pass_text']?></td>
						<td class=''><?=$data['type']?></td>
						<td class=''><?= $data['domain_url'] ?? '' ?></td>
						<td class=''><?=$data['status']?></td>

						<td>
                    
					       <a href="<?php echo base_url('admin/sub-admin-edit/') . $data['id']; ?>"><i class="fa fa-pencil-square-o text-primary fa-lg" aria-hidden="true"></i></a>
					        <a href="<?php echo base_url('admin/sub-admin-del/') . $data['id']; ?>" onclick="return confirm('Are you sure ?')" ><i class="fa fa-trash text-danger fa-lg" aria-hidden="true" onclick="delLead"></i></a>
