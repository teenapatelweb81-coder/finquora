        ...
        <div class="row m-0">
            <div class="col-md-12 p-0 form-main">
                <div class="card  form-card">
                    ...
                    <?php echo form_open_multipart('admin/terms_condition-update');?>
...
<?php }?>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" id="name" class="form-control" value="<?= (isset($datas['title'])) ? $datas['title'] : '' ; ?> " required>
                            <?php //echo form_error('first_name','<span class="text-danger mt-1">','</span>') ;?>
                        </div>
                        <div class="col-md-12">
                            <label for="description" class="form-label">Description<span class="text-danger">*</span></label>
                            <textarea name="description" id="description" class="form-control" required><?= (isset($datas['description'])) ? $datas['description'] : '' ; ?></textarea>
                            <?php //echo form_error('description','<span class="text-danger mt-1">','</span>'); ?>
                        </div>

                        <div class="col-md-6">
                            <label for="first_name" class="form-label">Background Image<span class="text-danger">*</span></label>
                            <input type="file" name="background_img" id="background_img" class="form-control" >
                            <?php if(isset($datas['background_img'])){ ?>
                                <img src="<?= base_url('assets/images/terms-condition/'.$datas['background_img']) ?>" alt="Image" width="100">
                                <?php } ?>
                            <?php //echo form_error('first_name','<span class="text-danger mt-1">','</span>') ;?>
                        </div>
