<div class="container-fluid p-0">
    ...
    <ol class="breadcrumb ">
        ...
        <li class="breadcrumb-item active" aria-current="page">Government Services</li>
    </ol>
    </nav>
</div>
            ...
            <div class="row align-items-end">
                <div class="col-md-3 mt-2">
                    <label for="Image Alt Description" class="form-label">Title <span class="text-danger">*</span></label>
                      ...
                      <input type="hidden" name="type" value="government_services">
			...
			<table class="table table-bordered text-center table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td class=''><?php echo $state->name ?? ''; ?></td>                                               
						...
						<td class=''>
							...
							<button type='button' class='btn btn-danger btn-sm delete-btn' data-id='<?php echo $data->id; ?>'>
...
$(document).ready(function() {
    ...
    $('#confirmDelete').on('click', function() {
        if (deleteId) {
            $.ajax({
                url: '<?php echo base_url("admin/Dashboard/delete_government_service/"); ?>' + deleteId,
                type: 'POST',
                dataType: 'json',
...
$('#assignUserBtn').on('click', function () {
    ...
    $.ajax({
        url: '<?= base_url("admin/Dashboard/government_services_assign_user"); ?>',
        type: 'POST',
        dataType: 'json',
        data: {
            team_id: teamId,
