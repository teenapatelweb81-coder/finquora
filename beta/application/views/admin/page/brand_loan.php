<div class="container-fluid p-0">
    ...
    <ol class="breadcrumb ">
        ...
        <li class="breadcrumb-item active" aria-current="page">Brand loan</li>
    </ol>
    </nav>
</div>
            ...
            <div class="row align-items-end">
                <div class="col-md-3 mt-2">
                    <label for="Image Alt Description" class="form-label">Title <span class="text-danger">*</span></label>
                      ...
                      <input type="hidden" name="type" value="brand_loan">
...
$(document).ready(function() {
    ...
    $('#confirmDelete').on('click', function() {
        if (deleteId) {
            $.ajax({
                url: '<?php echo base_url("admin/Dashboard/delete_brand_loan/"); ?>' + deleteId,
                type: 'POST',
                dataType: 'json',
...
$('#assignUserBtn').on('click', function () {
    ...
    $.ajax({
        url: '<?= base_url("admin/Dashboard/brand_loan_assign_user"); ?>',
        type: 'POST',
        dataType: 'json',
        data: {
            team_id: teamId,
