...
<div class="container">
	<div class="row">
		<div class="col-md-12 px-0">
			...
			<a href="<?php echo base_url('add-category') ;?>" class="btn btn-primary float-right mb-3"><i class="fa fa-plus" aria-hidden="true"></i> Add New Category </a>
			...
			<table class="table table-bordered text-center table-hover shadow-lg">
				...
				<tbody>
					...
					<tr>
						...
						<td class=''><?php echo ucwords($data->category); ?></td>
						...
						<td class=''>
					   <a href="<?php echo base_url('edit-category/').$data->id;?>"><i class="fa fa-pencil-square-o text-warning fa-lg" aria-hidden="true"></i></a>
					   <a href="<?php echo base_url('delete-category/').$data->id;?>"><i class="fa fa-trash text-danger fa-lg" aria-hidden="true"></i></a> 
						</td>
					</tr>
				   <?php $num++;  } } else {?>
