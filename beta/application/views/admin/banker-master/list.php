    ...
    <div class="row m-0">
		<div class="col-md-12 px-0">
		    ...
		    <div id="" class="text-primary text-right mb-2">
                <a href="<?php echo base_url() ?>admin/bankmaster-add" class="btn btn-primary mr-2"><i class="fa fa-plus text-light fa-sm" aria-hidden="true"></i> Add</a>
			...
			<table class="table table-bordered text-center table-hover" >
				...
				<tbody id="leadBody">
					...
					<tr>
						...
						<td>
                        <!-- -->
					       <a href="<?php echo base_url('admin/bankmaster-edit/') . $data->id; ?>"><i class="fa fa-pencil-square-o text-primary fa-lg" aria-hidden="true"></i></a>
					        <a href="<?php echo base_url('admin/Dashboard/bankermaster_del/') . $data->id; ?>" onclick="return confirm('Are you sure ?')" ><i class="fa fa-trash text-danger fa-lg" aria-hidden="true" onclick="delLead"></i></a>
