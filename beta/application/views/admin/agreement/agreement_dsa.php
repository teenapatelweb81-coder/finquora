...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">DSA Agreement</li> 
            </ol>
         </nav>
</div>
            ...
            <div class="col-md-12 px-0 form-main">
                ...
                <span class="text-center text-danger mb-2" id="errid"> <?php echo $this->session->flashdata('error'); ?></span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            <label for="heading" class="form-label">DSA Agreement heading</label>
                            <input type="text" name="heading" id="heading" class="form-control" value="<?= (isset($datas['heading'])) ? $datas['heading'] : '' ; ?>">
                            <input type="hidden" name="type" id="type" class="form-control" value="dsa_agreement">
                        </div>
                        <div class="col-md-12 mb-2">
                            <label for="heading" class="form-label">DSA Agreement content</label>
