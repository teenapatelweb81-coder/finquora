...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">Leads Transfer</li>
           </ol>
         </nav>
</div>
	...
	<div class="col-md-12 px-0">
			<?php echo form_open_multipart('admin/Slider/heading_update');?>
				...
				<div class="col-md-4 mt-2">
                  ...
                  <div class="input-group">
                     <input type="text" name="color" id="color" class="form-control" placeholder="Add color" value="<?= (isset($heading->color)) ? trim($heading->color) : '' ; ?>">
                     <input type="color" id="color_picker" class="form-control form-control-color" value="<?= (isset($heading->color)) ? trim($heading->color) : '' ; ?>">
                  </div>
		...
		<div class="col-md-12 px-0">
			...
			<div class="table-responsive ">
				<a href="<?php echo base_url('admin/add-lead-transfer') ;?>" class="btn btn-primary float-right my-2 pr-2"><i class="fa fa-plus" aria-hidden="true"></i> Add New lead </a>
