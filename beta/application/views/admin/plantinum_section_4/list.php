...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">plantinum section 4 list</li>
           </ol>
         </nav>
</div>
<div class="container">
    ...
    <div class="row">
		<div class="col-md-12 mt-4  pt-2 shadow-lg">
		    ...
		    <div id="" class="text-primary text-right mr-3">
                <a href="<?php echo base_url() ?>admin/plantinum-section-4-add" class="btn btn-primary"><i class="fa fa-plus text-light fa-sm" aria-hidden="true"></i> Add</a>
        ...
        ?>
					<tr>
						...
						<td>
					       ...
					       <a href="<?php echo base_url('admin/plantinum-section-4-edit/') . $data['id']; ?>"><i class="fa fa-pencil-square-o text-primary fa-lg" aria-hidden="true"></i></a>
					        <a href="<?php echo base_url('admin/plantinum-section-4-del/') . $data['id']; ?>" onclick="return confirm('Are you sure ?')" ><i class="fa fa-trash text-danger fa-lg" aria-hidden="true" onclick="delLead"></i></a>
