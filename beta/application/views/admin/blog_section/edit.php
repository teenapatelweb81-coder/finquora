        ...
        <div class="row">
            <div class="col-md-12 px-0 form-main">
                <div class="card  form-card">
                    ...
                    <?php echo form_open_multipart('admin/blog-section-update');?>
                    <span class="text-center text-info mb-2" id="susid"> <?php echo $this->session->flashdata('success'); ?></span>
                <span class="text-center text-danger mb-2" id="errid"> <?php echo $this->session->flashdata('error'); ?></span>
                    
                    <div class="row">
                        <input type="hidden" name="id" id="uid" class="form-control" value="<?php echo $blogSection['id']; ?>" >
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="heading" id="heading" class="form-control" value="<?php echo $blogSection['heading'];?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="title" id="title" class="form-control" value="<?php echo $blogSection['title'];?>" required>
                            <?php //echo form_error('first_name','<span class="text-danger mt-1">','</span>') ;?>
                        </div>
                        <div class="col-md-6">
                            <label for="description" class="form-label">Text<span class="text-danger">*</span></label>
                            <input name="text" id="text" class="form-control" required value="<?php echo $blogSection['text']; ?>" >
                            <?php //echo form_error('description','<span class="text-danger mt-1">','</span>'); ?>
                        </div>

                        <div class="col-md-6">
                            <label for="image" class="form-label">Image<span class="text-danger">*</span></label>
                            <input type="file" name="image" id="image" class="form-control" <?php if(empty($blogSection['image'])){ ?> required <?php } ?> >
                            <?php if(!empty($blogSection['image'])){ ?>
                            <img src="<?= base_url('assets/images/blogSection/'.$blogSection['image']) ?>" alt="Image" width="100">
                            <?php } ?>
                            <?php //echo form_error('description','<span class="text-danger mt-1">','</span>'); ?>
                        </div>
