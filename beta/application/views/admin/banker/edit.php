...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">Edit Banker</li>
           </ol>
         </nav>
</div>
        ...
        <div class="row">
            <div class="col-md-12 px-0 form-main">
                <div class="card  form-card">
                    ...
                    <?php echo form_open_multipart('admin/banker-update'); ?>
                    ...
                    <div class="row">
                          <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="state" id="state" class="form-control" value="<?php echo $datas->state; ?>" required>
                            <?php //echo form_error('mobile','<span class="text-danger mt-1">','</span>') ;?>
                        </div>
                          <div class="col-md-6 mb-3">
                            <label for="city" class="form-label">City<span class="text-danger">*</span></label>
                            <input type="text" name="city" id="city" class="form-control" value="<?php echo $datas->city; ?>" required>
                            <?php //echo form_error('mobile','<span class="text-danger mt-1">','</span>') ;?>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="Process" class="form-label">Bank Name<span class="text-danger">*</span></label>
                              <input type="text" name="bank_id" id="bank_id" class="form-control"  value="<?php echo $datas->bank_id; ?>" required>
