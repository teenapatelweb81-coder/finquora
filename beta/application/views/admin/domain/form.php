   ...
   <div class="row">
      <div class="col-md-12 px-0 form-main">
         <div class="card  form-card">
            ...
            <?php echo form_open_multipart('admin/rolepermission/domainCreate');?>
            
            <div class="row">
                <div class="col-md-4 mt-2">
                    <label for="Image Alt Description" class="form-label">Domain Url <span class="text-danger">*</span></label>
                      <input type="text" name="url" id="url" class="form-control" value="<?= set_value('url'); ?>" required placeholder="Add Domain url">
