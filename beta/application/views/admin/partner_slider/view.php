...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">Partner Slider Details</li>
           </ol>
         </nav>
</div>
<div class="container-fluid">
	...
	<div class="col-md-12">
		...
		<div class="col-md-12 px-0">
			...
			<a href="<?php echo base_url('admin/add-partner-slider') ;?>" class="btn btn-primary float-right mb-3"><i class="fa fa-plus" aria-hidden="true"></i> Add New Partner Slider </a>
			...
			<table class="table table-bordered text-center table-hover shadow-lg">
				...
				<tbody>
					...
					<tr>
						...
						<td class=''>
					   <a href="<?php echo base_url('admin/edit-partner-slider/').$data->id;?>"><i class="fa fa-pencil-square-o text-warning fa-lg" aria-hidden="true"></i></a>
					   <a href="<?php echo base_url('admin/delete-partner-slider/').$data->id;?>"><i class="fa fa-trash text-danger fa-lg" aria-hidden="true"></i></a> 
						</td>
					</tr>
				   <?php $num++;  } } else {?>
				   <tr><td colspan="8">Partner Slider data not available.</td></tr>
				   <?php }?>
				</tbody>
			</table>
			</div>
    ...
    $(document).on('click','.status_checks',function() {
        ...
        var newstatus = (status=='0')? '1':'0';
         if(confirm("Are you sure to "+ msg)) {
                  $.ajax({
                  type:"POST",
                  url: "<?= base_url('admin/update_lead-transfer'); ?>", 
