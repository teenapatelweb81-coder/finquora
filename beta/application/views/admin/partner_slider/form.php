   ...
   <div class="row">
      <div class="col-md-12 px-0 form-main">
         <div class="card  form-card">
            ...
            <?php echo form_open_multipart('admin/add-partner-slider');?>
            ...
            <div class="row">
             ...
             <div class="form-group col-md-6 mt-2">
                     <label for="Image Alt Description" class=" col-form-label">Partner Image(Upload size Max 2 MB) <span class="text-danger">*</span></label>
                     <input type="file" name="slider_image" id="slider_image" class="form-control" title="Enter  image" placeholder="Add image" >
