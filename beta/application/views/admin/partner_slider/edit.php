...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">partner Slider  Form</li>
           </ol>
         </nav>
</div>
   ...
   <div class="row">
      <div class="col-md-12 px-0 form-main">
         <div class="card  form-card">
            ...
            <?php echo form_open_multipart('admin/update-partner-slider',['id'=>'sliderfrmm']);?>
               ...
               <?php }?>        
                ...
                <div class=" col-md-6 mt-2">
                 ...
                 <div class="form-group col-md-6 mt-4">
                     ...
                     <label for="Image Alt Description" class=" col-form-label">partner Slider Image(Upload size Max 2 MB)</label>
            ...
            <div class="form-group">
               ...
               <a href="<?php echo base_url('admin/partner_slider') ;?>" class="btn btn-secondary mt-4">Show</a>
            </div>
            <?php echo form_close();?>
         </div>
      </div>
