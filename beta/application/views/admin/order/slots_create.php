...
<div class="container-fluid p-0">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">Addt Payout Slabs</li>
           </ol>
         </nav>
</div>
   ...
   <div class="row">
      <div class="col-md-12 px-0 form-main">
         <div class="card  form-card">
           ...
           <?php echo form_open_multipart('admin/my-payout-createdata');?>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-2">
                    <label for="slab_A_per" class="form-label">Slot A<span class="text-danger">*</span></label>
                      <input type="text" name="slab_A" id="slab_A" class="form-control" required>
                       <?php echo form_error('slab_A','<span class="text-danger mt-1">','</span>') ;?>
                </div>
                
                <!-- <div class="col-md-6 mb-2">
                    <label for="slab_A_per" class="form-label">Slot A(%)<span class="text-danger">*</span></label>
                      <input type="text" name="slab_A_per" id="slab_A_per" class="form-control" required>
                ...
                <div class="col-md-6 mb-2">
                    <label for="slab_B" class="form-label">Slot B<span class="text-danger"></span></label>
                      <input type="text" name="slab_B" id="slab_B" class="form-control"  >
                ...
                <!-- <div class="col-md-6 mb-2">
                    <label for="slab_B_per" class="form-label">Slot B(%)<span class="text-danger"></span></label>
                      <input type="text" name="slab_B_per" id="slab_B_per" class="form-control"  >
                ...
                <div class="col-md-6 mb-2">
                    <label for="slab_C" class="form-label">Slot C<span class="text-danger">*</span></label>
                      <input type="text" name="slab_C" id="slab_C" class="form-control"  required>
                ...
                <!-- <div class="col-md-6 mb-2">
                    <label for="slab_C_per" class="form-label">Slot C(%)<span class="text-danger">*</span></label>
                      <input type="text" name="slab_C_per" id="slab_C_per" class="form-control"    required>
                ...
                <div class="col-md-6 mb-2">
                    <label for="slab_D" class="form-label">Slot D<span class="text-danger"></span></label>
                      <input type="text" name="slab_D" id="slab_D" class="form-control"  >
                ...
                <!-- <div class="col-md-6 mb-2">
                    <label for="slab_D_per" class="form-label">Slot D(%)<span class="text-danger"></span></label>
                      <input type="text" name="slab_D_per" id="slab_D_per" class="form-control"   >
                ...
                <div class="col-md-6 mb-2">
                    <label for="starperformer" class="form-label">starperformer<span class="text-danger">*</span></label>
                      <input type="text" name="starperformer" id="starperformer" class="form-control"    required>
                ...
                <!-- <div class="col-md-6 mb-2">
                    <label for="starperformance_per" class="form-label">Starperformance(%)<span class="text-danger">*</span></label>
                      <input type="text" name="starperformance_per" id="starperformance_per" class="form-control"   required>
            ...
            <div class="row">
                <div class="col-md-5"></div>
                    <div class="col-md-2"> 
                        ...
                        <button type="submit" value="update" class="btn btn-info mt-4"> Add </button>
                        </div>
                    </div>
                <div class="col-md-5"></div>
            </div>
