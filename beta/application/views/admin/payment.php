...
<div class="payment-container">
    ...
    <div class="logo-section">
        <a href="<?= str_replace('/beta/', '/', base_url()); ?>">
            <img src="<?= str_replace('/beta/', '/', base_url()); ?>upload/assets/logo.png" alt="image">
        </a>
    </div>

    <h3 style="font-size:21px;">Complete Your Payment</h3>
    <p>Payment is made to EXELORA CONSULTANCY PRIVATE LIMITED</p>
    ...
    <div class="col-md-7 form-section">
        ...
        <div class="col-md-5 qr-bank-section">
            ...
            <img src="https://instantloansdeals.com/upload/assets/qrcode.jpg" alt="QR Code" style="width:150px;">
            <h5>Scan to Pay</h5>
            <!--<p>Company Name: EXELORA CONSULTANCY PRIVATE LIMITED</p>-->
            <p>Bank Name: Saraswat Bank</p>
            <p>Account Number: 610000000028232</p>
            <p>IFSC Code: SRCB0000064</p>
            <p>UPI: vinaygupta8141-13@okaxis</p>
        </div>
    </div>
