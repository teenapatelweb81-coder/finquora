      ...
      <div class="col-md-12">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
               ...
               <li class="breadcrumb-item active" aria-current="page">Our story list</li>
           </ol>
         </nav>
</div>
    ...
    <div class="row m-0">
		<div class="col-md-12">
		    ...
		    <div id="" class="text-primary text-right mr-3">
                <a href="<?php echo base_url() ?>admin/our-story-add" class="btn btn-primary"><i class="fa fa-plus text-light fa-sm" aria-hidden="true"></i> Add</a>
