...
<div class="container-fluid p-0">
     <nav aria-label="breadcrumb">
        <ol class="breadcrumb ">
           ...
           <li class="breadcrumb-item active" aria-current="page"><?=ucwords($_GET['role']);?> Approved Leads</li>
       </ol>
     </nav>
</div>
					...
					<?php
                      ...
                      $role = isset($_GET['role']) ? $_GET['role'] : '';
                        ...
                        if ($role == 'paper' && $type == 'team') {
                            $datas = $team_approved_lead_paper;

                        } elseif ($role == 'digital' && $type == 'team') {
                            $datas = $team_approved_lead_digital;

                        } elseif ($role == 'paper') {
                            $datas = $paper_Approved;

                        } else {
                            $datas = $digital_Approved;
                        }
