...
<div class="container-fluid p-0">
     <nav aria-label="breadcrumb">
        <ol class="breadcrumb ">
           ...
           <li class="breadcrumb-item active" aria-current="page"><?=ucwords($_GET['role']);?> Payout Leads</li>
       </ol>
     </nav>
</div>
					...
					<?php
                      ...
                      $role = isset($_GET['role']) ? $_GET['role'] : '';
                        ...
                        if ($role === 'paper' && $type === 'team') {
                            $datas = $team_payout_lead_paper;

                        } elseif ($role === 'digital' && $type === 'team') {
                            $datas = $team_payout_lead_digital;

                        } elseif ($role === 'paper') {
                            $datas = $payout_lead_paper;

                        } else {
                            $datas = $payout_lead_digital;
                        }
                        // echo "<pre>";
                        // print_r($datas);
                        // die;
                ...
                <tr>
                    ...
                    <!-- <td><?=$data->lead_status;?></td> -->
                      <?php  if (!empty($parent_id) && $this->session->userdata('role') != 1) {?>
                        <td><?= $data->payment_amount_paid_team;?></td>
                        <?php }else{ ?>
