...
<div class="container-fluid p-0">
     <nav aria-label="breadcrumb">
        <ol class="breadcrumb ">
           ...
           <li class="breadcrumb-item active" aria-current="page"><?=ucwords($_GET['role']);?> My Leads</li>
       </ol>
     </nav>
</div>
				...
				<tbody>
					...
					<?php
                        ...
                        if ($role === 'paper' && $type === 'team') {
                            $datas = $team_leads_paper;

                        } elseif ($role === 'digital' && $type === 'team') {
                            $datas = $team_leads_digital;

                        } elseif ($role === 'paper') {
                            $datas = $paperProcessLeads;

                        } else {
                            $datas = $leads;
                        }

                        // $datas = ($_GET['role'] == 'paper') ? $paperProcessLeads : $leads;
                        if (!empty($datas)) {
                            $num = count($datas);
